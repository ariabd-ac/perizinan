...
<section class="section">
  ...
  <div class="section-body">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <form action="<?= site_url('c_korpokla/update/' . $korpokla->korpokla_id) ?>" method="post" autocomplete="off">
          <?= csrf_field() ?>
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <input type="text" name="korpokla_name" class="form-control" required value="<?= $korpokla->korpokla_name ?>">
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <input type="text" name="desc" class="form-control" value="<?= $korpokla->desc ?>">
            </div>
          </div>
          <div class="row">
